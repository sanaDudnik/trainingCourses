 ...
 */
public class TrainingCoursesManager extends GeneratedTrainingCoursesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TrainingCoursesManager.class.getName());
	 ...
	 */
	public static TrainingCoursesManager getInstance()
	{
		return (TrainingCoursesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TrainingCoursesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TrainingCoursesManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TrainingCoursesManager called.");
		}
	}
